...
def parse_args():
    ...
    parser.add_argument('--l2', type=float, default=1e-2, help='l2 regularization weight, 1e-5 for NGCF')
    ...
    parser.add_argument('--topK2', type=int, default=40,
                        help='topK2')

    parser.add_argument('--topK3', type=int, default=80,
                        help='topK3')
